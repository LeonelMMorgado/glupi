...
void octree_insert(Octree *tree, Voxel_Object *voxel) {
    ...
    if(tree->voxel->coord.y > MIN_HEIGHT && !tree->children) {
        ...
        tree->children[1] = octree_create((IVector3){mid_points.x, tree->top_left_front.y, tree->top_left_front.z}, //top right front
                                          (IVector3){tree->bot_right_back.x, mid_points.y, mid_points.z});
        tree->children[2] = octree_create((IVector3){tree->top_left_front.x, tree->top_left_front.y, mid_points.z}, //top left back
                                          (IVector3){mid_points.x, mid_points.y, tree->bot_right_back.z});
        tree->children[3] = octree_create((IVector3){mid_points.x, tree->top_left_front.y, mid_points.z},           //top right back
                                          (IVector3){tree->bot_right_back.x, mid_points.y, tree->bot_right_back.z});
        tree->children[4] = octree_create((IVector3){tree->top_left_front.x, mid_points.y, tree->top_left_front.z}, //bot left front
                                          (IVector3){mid_points.x, tree->bot_right_back.y, tree->bot_right_back.z});
        tree->children[5] = octree_create((IVector3){mid_points.x, mid_points.y, tree->top_left_front.z},           //bot right front
                                          (IVector3){tree->bot_right_back.x, tree->bot_right_back.y, mid_points.z});
        tree->children[6] = octree_create((IVector3){tree->top_left_front.x, mid_points.y, mid_points.z},           //bot left back
                                          (IVector3){mid_points.x, tree->bot_right_back.y, tree->bot_right_back.z});
